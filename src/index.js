...
function App() {
  ...
  return (
    <Canvas
      ...
      <fog attach="fog" args={['white', 50, 10]} />
      <pointLight distance={100} intensity={4} color="white" />
      <Number mouse={mouse} hover={hover} />
      <Particles count={isMobile ? 0 : 0} mouse={mouse} />
      <Sparks count={80} mouse={mouse} colors={['#A2CCB6', '#FCEEB5', '#EE786E', '#e0feff', 'lightred', 'lightblue']} />
      <Effects />
    </Canvas>
  )
}
